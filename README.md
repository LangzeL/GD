...
2. **After making changes to the UI/UX of the website**, check the comparison generated by **BackstopJS** and ensure the modification is suitable and accessible from various devices.
